...
changelog:
  - "bokss-skill copy: patterns 38→53. 第 39–53 種為 Wikipedia-style 補遺（MIT 對照 humanizer-zh-tw／blader/humanizer；例子重寫）。非正式上游版本。"
...
按 [references/patterns.md](references/patterns.md) 的 53 種痕跡逐類處理，優先序：
...
- 53 種 AI 痕跡與範例句（1–38 上游；39–53 為本 copy 的 Wikipedia-style 補遺）：[references/patterns.md](references/patterns.md)
